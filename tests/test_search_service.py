...
def make_public_user(username: str, display_name: str | None = None, headline: str | None = None):
...
def add_privacy(user, visibility: str = "public", searchable: bool = True, mode: str = "public"):
